/*
 * $Id: RtfImage2.java,v 1.2 2009/09/18 22:43:05 robert Exp $
 *
...
/**
 * THIS IS A COPY OF ITEXT version twicked for producing image content.
 * The RtfImage contains one image. Supported image types are jpeg, png, wmf, bmp.
 * 
 * @version $Id: RtfImage2.java,v 1.2 2009/09/18 22:43:05 robert Exp $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 * @author Paulo Soares
 * @author Thomas Bickel (tmb99@inode.at)
 */
public class RtfImage2 extends RtfElement {
     ...
     */
    public RtfImage2(RtfDocument doc, Image image) throws DocumentException
    {
        super(doc);
     ...
     */ 
    public void writeContent(final PrintStream result) throws IOException
    {
